import { sha256Hash, hashLeftRight, hash3, hash4, hash5, generateRandomSalt } from "@znurznurznur/extended-maci-crypto";
...
describe("Hasher", () => {
  ...
  it("@znurznurznur/extended-maci-crypto.sha256Hash should match hasher.sha256Hash", async () => {
    const values: string[] = [];
    for (let i = 0; i < 5; i += 1) {
  ...
  it("@znurznurznur/extended-maci-crypto.hashLeftRight should match hasher.hashLeftRight", async () => {
  ...
  it("@znurznurznur/extended-maci-crypto.hash3 should match hasher.hash3", async () => {
  ...
  it("@znurznurznur/extended-maci-crypto.hash4 should match hasher.hash4", async () => {
    const values: BigNumberish[] = [];
  ...
  it("@znurznurznur/extended-maci-crypto.hash5 should match hasher.hash5", async () => {
    const values: BigNumberish[] = [];
